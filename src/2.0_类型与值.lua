...
------------------------------------ type函数 ----------------------------------
-- type(val) 函数将返回值val的类型描述。其返回值如下所示：
--      "number": 当val的值为数字时
--      "string": 当val的值为字符串时
--      "nil": 当val的值为nil时
--      "table": 当val的值为table类型时
--      "function": 当val的值为一个函数时
print("type()")
print("", "type('a') = " .. type('a'), "type(nil) = " .. type(nil))
print("", "type(1) = " .. type(1), "type({}) = " .. type({}), "type(function() return 1 end) = " .. type(function() return 1 end))
